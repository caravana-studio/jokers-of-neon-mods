#[dojo::contract]
pub mod special_season2_5 {
    use dojo::model::ModelStorage;
    use jokers_of_neon_classic::constants::DEFAULT_NS;
    use jokers_of_neon_classic::specials::specials::SPECIAL_SEASON2_5_ID;
    ...
    #[abi(embed_v0)]
    impl Season2_5Executable of ICardExecutable<ContractState> {
    ...
    #[abi(embed_v0)]
    impl Season2_5Base of ICardBase<ContractState> {
    ...
    #[abi(embed_v0)]
    impl Season2_5Info of ICardInfo<ContractState> {
