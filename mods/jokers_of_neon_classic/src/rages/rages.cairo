...
pub const RAGE_CARD_DEBUFF_FLUSH: u32 = 20042;
pub const RAGE_CARD_CHAOTIC_VARIANCE: u32 = 20043;
...
pub fn rages_info() -> (Span<Span<u32>>, Span<u32>, Span<u32>, Span<u32>) {
    ...
    let A_RAGES = array![RAGE_CARD_DIMINISHED_HOLD, RAGE_CARD_CHAOTIC_VARIANCE, RAGE_CARD_OBSESSIVE_REPETITION].span();
