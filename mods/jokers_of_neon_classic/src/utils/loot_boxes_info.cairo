...
pub mod loot_boxes_info {
    use jokers_of_neon_classic::loot_box::{get_loot_box, loot_boxes_ids_all, loot_boxes_shop_info};
    use jokers_of_neon_lib::interfaces::info::loot_boxes_info::ILootBoxesInfo;
