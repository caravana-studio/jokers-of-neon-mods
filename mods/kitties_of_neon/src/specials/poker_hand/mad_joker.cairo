...
pub mod special_mad_joker {
    use jokers_of_neon_classic_v18::specials::specials::SPECIAL_MAD_JOKER_ID;
    ...
    #[abi(embed_v0)]
    impl MadJokerExecutable of ICardExecutable<ContractState> {
    ...
    #[abi(embed_v0)]
    impl MadJokerBase of ICardBase<ContractState> {
