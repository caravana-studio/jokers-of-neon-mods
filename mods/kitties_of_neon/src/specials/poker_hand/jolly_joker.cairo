...
pub mod special_jolly_joker {
    use jokers_of_neon_classic_v18::specials::specials::SPECIAL_JOLLY_JOKER_ID;
    ...
    #[abi(embed_v0)]
    impl JollyJokerExecutable of ICardExecutable<ContractState> {
    ...
    #[abi(embed_v0)]
    impl JollyJokerBase of ICardBase<ContractState> {
