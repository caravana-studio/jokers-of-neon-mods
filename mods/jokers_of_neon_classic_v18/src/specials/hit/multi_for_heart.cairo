...
pub mod special_multi_for_heart {
    use jokers_of_neon_classic_v18::specials::specials::SPECIAL_MULTI_FOR_HEART_ID;
    ...
    #[abi(embed_v0)]
    impl MultiHeartCondition of ICardCondition<ContractState> {
    ...
    #[abi(embed_v0)]
    impl MultiHeartExecutable of ICardExecutable<ContractState> {
