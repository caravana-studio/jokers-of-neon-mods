#[dojo::contract]
mod special_scaling_factor {
    use jokers_of_neon_classic_v18::poker_hand::get_poker_hand_data;
    use jokers_of_neon_classic_v18::specials::specials::SPECIAL_SCALING_FACTOR_ID;
