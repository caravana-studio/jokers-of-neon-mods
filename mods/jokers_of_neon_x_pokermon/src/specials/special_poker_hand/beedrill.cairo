...
pub mod special_beedrill {
    ...
    use jokers_of_neon_x_pokermon::specials::specials::SPECIAL_BEEDRILL_ID;

    #[abi(embed_v0)]
    impl SpecialBeedrillImpl of ISpecialPokerHand<ContractState> {
        fn execute(
