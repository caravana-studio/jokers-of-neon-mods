...
pub mod special_caterpie {
    ...
    use jokers_of_neon_x_pokermon::specials::specials::SPECIAL_CATERPIE_ID;

    #[abi(embed_v0)]
    impl SpecialCaterpieImpl of ISpecialPokerHand<ContractState> {
        fn execute(
