...
const SPECIAL_POINTS_FOR_FIGURES_ID: u32 = 303;
const SPECIAL_MULTI_FOR_SPADE_ID: u32 = 304;
const SPECIAL_MULTI_FOR_HEART_ID: u32 = 305;
const SPECIAL_POWER_UP_BOOSTER_ID: u32 = 306;
const SPECIAL_INITIAL_ADVANTAGE_ID: u32 = 307;
const SPECIAL_MULTI_ACES_ID: u32 = 308;
const SPECIAL_INCREASE_LEVEL_THREE_OF_A_KIND_ID: u32 = 309;
const SPECIAL_SCORE_ODD_ID: u32 = 310;
...
fn specials_shop_info() -> (Span<Span<u32>>, Span<u32>, Span<u32>) {
    ...
    let B_SPECIALS = array![SPECIAL_MULTI_ACES_ID, SPECIAL_EXTRA_HELP_ID].span();
    ...
    let S_SPECIALS = array![SPECIAL_JOKER_BOOSTER_ID, SPECIAL_POINTS_FOR_FIGURES_ID].span();
