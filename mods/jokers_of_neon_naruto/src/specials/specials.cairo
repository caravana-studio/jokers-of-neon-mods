...
fn specials_shop_info() -> (Span<Span<u32>>, Span<u32>, Span<u32>) {
    ...
    let C_SPECIALS = array![SPECIAL_INCREASE_LEVEL_PAIR_ID, SPECIAL_INCREASE_LEVEL_DOUBLE_PAIR_ID]
        .span();
    ...
    let A_SPECIALS = array![
        SPECIAL_HAND_THIEF_ID, SPECIAL_DISCARD_MASTERY_ID, SPECIAL_SCORE_EVEN_ID
    ]
        .span();
    ...
    let SS_SPECIALS = array![
        SPECIAL_INITIAL_ADVANTAGE_ID, SPECIAL_POWER_UP_BOOSTER_ID, SPECIAL_HIGH_CARD_BOOSTER_ID
    ]
        .span();
