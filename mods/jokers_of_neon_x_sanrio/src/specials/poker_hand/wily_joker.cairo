#[dojo::contract]
pub mod special_wily_joker {
    use jokers_of_neon_classic_v18::specials::specials::SPECIAL_WILY_JOKER_ID;
    ...
    #[abi(embed_v0)]
    impl WilyJokerExecutable of ICardExecutable<ContractState> {
    ...
    #[abi(embed_v0)]
    impl WilyJokerBase of ICardBase<ContractState> {
