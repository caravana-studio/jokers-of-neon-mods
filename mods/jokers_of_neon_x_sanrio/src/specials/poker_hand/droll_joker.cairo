...
pub mod special_droll_joker {
    use jokers_of_neon_classic_v18::specials::specials::SPECIAL_DROLL_JOKER_ID;
    ...
    #[abi(embed_v0)]
    impl DrollJokerExecutable of ICardExecutable<ContractState> {
    ...
    #[abi(embed_v0)]
    impl DrollJokerBase of ICardBase<ContractState> {
